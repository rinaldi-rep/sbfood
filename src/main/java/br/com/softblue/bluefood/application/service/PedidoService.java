...
import br.com.softblue.bluefood.domain.pedido.Status;
...
public class PedidoService {
	...
	public Pedido criarEPagar(Carrinho carrinho, String numCartao) throws PagamentoException {
		...
		HttpEntity<DadosCartao> resquestEntity = new HttpEntity<>(dadosCartao, headers);
		RestTemplate restTemplate = new RestTemplate();

		Map<String, String> response;
		try {
			response = restTemplate.postForObject(sbPayUrl, resquestEntity, Map.class);
		} catch (Exception e) {
